...
const featuredUnits = [
  { title: 'Camera Rental', category: 'Camera', icon: Camera },
  { title: 'Smartphone Rental', category: 'Smartphone', icon: Smartphone },
  { title: 'Vehicle Rental', category: 'Vehicle', icon: Car },
  { title: 'Digital Camera', category: 'Camera', icon: Camera },
  { title: 'Latest Smartphone', category: 'Smartphone', icon: Smartphone },
  { title: 'Car Rental', category: 'Vehicle', icon: Car },
];
...
>
  <div className="text-left">
    ...
    <h1 className="mt-6 whitespace-nowrap text-3xl font-bold leading-[1.05] tracking-tight text-neutral-900 sm:text-5xl lg:text-6xl">
      Renting made simple. Browse, Book, Enjoy.
    </h1>
  </div>
  ...
  <div className="relative mt-8 h-[280px] overflow-hidden rounded-xl border border-neutral-300 bg-neutral-200 shadow-sm sm:h-[360px] lg:h-[420px]">
              ...
              {featuredUnits.map((unit, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="pt-4">
                      <p className="text-xs text-neutral-500">{unit.category}</p>
        ...
        <section
          id="why-rentspot"
          className="relative scroll-mt-[72px] overflow-hidden border-b border-slate-200 bg-[#F3F6FA] py-16 sm:py-20"
        >
          <div
            className="pointer-events-none absolute inset-0 opacity-20"
            style={whyGridBackground}
          />
