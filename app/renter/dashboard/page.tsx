    ...
    <div className="min-h-screen bg-neutral-50">
      ...
      <main className="mx-auto grid max-w-[1280px] gap-8 px-6 py-8 lg:grid-cols-[240px_minmax(0,1fr)] lg:px-10 lg:py-10">
        ...
        <section className="rounded-lg border border-neutral-200 bg-white px-6 py-7 shadow-sm sm:px-8">
          ...
          <div className="mt-1 flex flex-col justify-between gap-4 border-b border-neutral-100 pb-6 sm:flex-row sm:items-end">
            ...
            <Link href="/guest/browse" className="inline-flex items-center justify-center gap-2 rounded-md bg-brand-500 px-5 py-2.5 text-sm font-semibold text-white transition hover:bg-brand-600">
              Browse Unit <ChevronRight className="h-4 w-4" />
            </Link>
          </div>
        ...
        <section className="mt-8 grid gap-5 md:grid-cols-3">
          <Link href="/renter/my-rentals" className="group flex h-full flex-col rounded-xl border border-neutral-200 bg-white p-6 shadow-sm transition hover:-translate-y-0.5 hover:border-blue-300 hover:shadow-md">
            ...
            <span className="mt-auto pt-5 inline-flex items-center gap-2 text-sm font-semibold text-blue-600">Open rentals <ChevronRight className="h-4 w-4 transition group-hover:translate-x-1" /></span>
          </Link>

          <Link href="/renter/kyc" className="group flex h-full flex-col rounded-xl border border-neutral-200 bg-white p-6 shadow-sm transition hover:-translate-y-0.5 hover:border-blue-300 hover:shadow-md">
            ...
            <span className="mt-auto pt-5 inline-flex items-center gap-2 text-sm font-semibold text-blue-600">Manage verification <ChevronRight className="h-4 w-4 transition group-hover:translate-x-1" /></span>
          </Link>

          <Link href="/guest/browse" className="group flex h-full flex-col rounded-xl border border-neutral-200 bg-white p-6 shadow-sm transition hover:-translate-y-0.5 hover:border-blue-300 hover:shadow-md">
            ...
            <span className="mt-auto pt-5 inline-flex items-center gap-2 text-sm font-semibold text-blue-600">Browse Unit <ChevronRight className="h-4 w-4 transition group-hover:translate-x-1" /></span>
          </Link>
        </section>
        ...
        <section className="mt-8 grid gap-8 lg:grid-cols-[1.4fr_0.6fr]">
          <div className="rounded-xl border border-neutral-200 bg-white p-6 shadow-sm sm:p-8">
            ...
            <div className="mt-8 border-t border-dashed border-neutral-200 pt-8 text-center">
              ...
              <Link href="/guest/browse" className="mt-5 inline-flex items-center gap-2 rounded-md border border-neutral-300 px-4 py-2.5 text-sm font-semibold text-neutral-700 transition hover:border-blue-500 hover:bg-blue-50 hover:text-blue-700">
                Explore available units <ChevronRight className="h-4 w-4" />
              </Link>
            </div>
          </div>
          ...
          <aside className="rounded-xl border border-blue-100 bg-blue-50 p-6 sm:p-8">
            ...
            {kycStatus === 'Approved' ? (
              ...
              <Link href="/renter/kyc" className="mt-6 inline-flex items-center gap-2 text-sm font-semibold text-blue-700 hover:text-blue-900">Complete verification <ChevronRight className="h-4 w-4" /></Link>
            )}
          </aside>
        </section>
        </div>
